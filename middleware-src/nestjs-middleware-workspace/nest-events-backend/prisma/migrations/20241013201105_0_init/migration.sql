...
-- CreateIndex
CREATE UNIQUE INDEX "StackExchange_title_key" ON "StackExchange"("title");

-- CreateIndex
CREATE UNIQUE INDEX "StackBoard_title_key" ON "StackBoard"("title");
